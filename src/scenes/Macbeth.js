class Macbeth extends Phaser.Scene {
    ...
    create() {
        ...
        this.witch1 = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'poeSister1').setOrigin(0, 1);
        this.witch2 = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'poeSister2').setOrigin(0, 1);
        this.witch3 = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'poeSister3').setOrigin(0, 1);
